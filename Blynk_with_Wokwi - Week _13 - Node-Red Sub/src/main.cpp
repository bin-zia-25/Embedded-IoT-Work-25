...
// ---------- MQTT ----------
const char* mqtt_server = "10.13.20.219"; // Change to your MQTT broker IP
const int mqtt_port = 1883;

const char* TOPIC_TEMP = "home/node_red/temp"; // Topic for temperature
